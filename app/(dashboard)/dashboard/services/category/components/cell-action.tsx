...
export const CellAction = ({
  ...
  const onConfirm = async () => {
    try {
      setLoading(true);
      await axios.delete(`/api/${name}/${data.id}`);
                ...
                <Tooltip>
                  ...
                  <TooltipTrigger>
                      <span className="text-lg text-default-400 cursor-pointer active:opacity-50">
                        <ViewIcon onClick={() => router.push(`services/${name}/${data.id}#view`)}/>
                      </span>
                  </TooltipTrigger>
                </Tooltip>
                <Tooltip>
                    ...
                    <TooltipTrigger>
                        <span className="text-lg text-default-400 cursor-pointer active:opacity-50">
                            <EditIcon onClick={() => router.push(`services/${name}/${data.id}#edit`)}/>
                          </span>
                    </TooltipTrigger>
                </Tooltip>
                <Tooltip>
