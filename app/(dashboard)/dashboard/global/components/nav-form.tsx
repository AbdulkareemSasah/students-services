...
export function formatTranslation(translations: NavbarItemTranslation[]): formatedTranslation {
...
function convertToTranslationArray(translationObject: formatedTranslation): NavbarItemTranslation[] {
...
const NavbarItemForm = ({initialData , pages, dropdownGroups, dropdownItems,articles}:NavbarItemFormProps) => {
    ...
    const [type, setType] = useState(
        initialData?.isDropdown ?"dropdown" :
                                                ...
                                                {dropdownGroups.map((d) => (
                                                    <CommandItem
                                                        ...
                                                        onSelect={() => {
                                                            ...
                                                            form.setValue(`dropdownGroups`, [...selectedIds, d.id]);
                                                        }}
                                                    >
                                                        <Check
                                                            className={cn(
    ...
    },[type, selectedLang,form, loading,pages,t,dropdownGroups,articles,dropdownItems])
